...
class GraphPrimTest {
    ...
    void leastSpanningTreeSimpleGraphTest() {
        int[][] matrix = {{0, 2, 3}, {2, 0, 1}, {3, 1, 0}};

        Graph graph = new Graph(matrix);

        int[][] result = GraphAlgorithms.getLeastSpanningTree(graph);

        int[][] expected = {{0, 2, 0}, {2, 0, 1}, {0, 1, 0}};
    ...
    void leastSpanningTreeLinearGraphTest() {
        ...
        int[][] expected = {{0, 1, 0, 0}, {1, 0, 2, 0}, {0, 2, 0, 3}, {0, 0, 3, 0}};
    ...
    void leastSpanningTreeChooseMinimalEdgesTest() {
        int[][] matrix = {{0, 10, 1}, {10, 0, 2}, {1, 2, 0}};

        Graph graph = new Graph(matrix);

        int[][] result = GraphAlgorithms.getLeastSpanningTree(graph);

        int[][] expected = {{0, 0, 1}, {0, 0, 2}, {1, 2, 0}};
    ...
    void leastSpanningTreeNullGraphTest() {
        assertThrows(WrongMatrixException.class, () -> GraphAlgorithms.getLeastSpanningTree(null));
    }
    ...
    void leastSpanningTreeDisconnectedGraphTest() {
        ...
        assertThrows(WrongMatrixException.class, () -> GraphAlgorithms.getLeastSpanningTree(graph));
    }

    @Test
    void leastSpanningTreeHugeWeightsTest() {
        int[][] matrix = {{0, 1_000_000, 3_000_000}, {1_000_000, 0, 2_000_000}, {3_000_000, 2_000_000, 0}};
    ...
    void leastSpanningTreeSquareGraphTest() {
        int[][] matrix = {{0, 1, 5, 1}, {1, 0, 1, 5}, {5, 1, 0, 1}, {1, 5, 1, 0}};
