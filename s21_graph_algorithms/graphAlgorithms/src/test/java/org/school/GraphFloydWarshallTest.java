...
class GraphFloydWarshallTest {
    ...
    void allShortestPathsSimpleGraphTest() {
        int[][] matrix = {{0, 2, 10}, {2, 0, 3}, {10, 3, 0}};

        Graph graph = new Graph(matrix);

        int[][] expected = {{0, 2, 5}, {2, 0, 3}, {5, 3, 0}};
    ...
    void allShortestPathsLinearGraphTest() {
        ...
        int[][] expected = {{0, 1, 3, 6}, {1, 0, 2, 5}, {3, 2, 0, 3}, {6, 5, 3, 0}};
    ...
    void allShortestPathsDisconnectedGraphTest() {
        ...
        int[][] expected = {{0, 1, inf}, {1, 0, inf}, {inf, inf, 0}};
    ...
    void allShortestPathsDenseGraphTest() {
        ...
        int[][] expected = {{0, 1, 3, 4}, {1, 0, 2, 3}, {3, 2, 0, 1}, {4, 3, 1, 0}};
    ...
    void allShortestPathsDirectedGraphTest() {
        ...
        int[][] expected = {{0, 5, 7}, {inf, 0, 2}, {inf, inf, 0}};
    ...
    void allShortestPathsNullGraphTest() {
        assertThrows(
            WrongMatrixException.class, () -> GraphAlgorithms.getShortestPathsBetweenAllVertices(null));
    }
    ...
    void allShortestPathsCycleGraphTest() {
        ...
        int[][] expected = {{0, 1, 3}, {1, 0, 2}, {3, 2, 0}};
    ...
    void allShortestPathsFullyDisconnectedGraphTest() {
        ...
        int[][] expected = {{0, inf, inf}, {inf, 0, inf}, {inf, inf, 0}};
    ...
    void allShortestPathsHugeWeightsTest() {
        int[][] matrix = {{0, 1_000_000, 0}, {1_000_000, 0, 1_000_000}, {0, 1_000_000, 0}};
    ...
    void allShortestPathsLongAlternativeRouteTest() {
        int[][] matrix = {
            {0, 100, 1, 0, 0}, {100, 0, 1, 1, 0}, {1, 1, 0, 50, 50}, {0, 1, 50, 0, 1}, {0, 0, 50, 1, 0}};
    ...
    void allShortestPathsSymmetricGraphTest() {
        int[][] matrix = {{0, 3, 0, 7}, {3, 0, 1, 0}, {0, 1, 0, 2}, {7, 0, 2, 0}};
